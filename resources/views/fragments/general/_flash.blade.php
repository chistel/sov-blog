@foreach (session('flash_notification', collect())->toArray() as $message)
    <div class="w-full">
        @if($message['level'] === 'danger')
            <div class="alert flex flex-row items-center bg-red-200 p-4 mb-1 rounded border-b-2 border-red-300">
                <div
        ...
        @elseif($message['level'] === 'success')
            <div class="alert flex flex-row items-center bg-green-200 p-4 mb-1 rounded border-b-2 border-green-300">
                <div
